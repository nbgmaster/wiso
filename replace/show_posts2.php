...
//          $str = str_replace("'", "&acute;", $str);
  ...
  preg_match_all("#\[QUOTE](.*)\[/QUOTE\]#Uis", $str, $strikes_Q, PREG_SET_ORDER);
  preg_match_all("#\[QUOTE=(.*)\](.*)\[/QUOTE\]#Uis", $str, $strikes_Q2, PREG_SET_ORDER);


      foreach ($strikes_Q as $content_Q)  {
...
if ($do != "profile")  {
      ...
      foreach ($strikes_Q2 as $content_Q)  {
