...
$qy_NwP   = mysql_query("SELECT id, message from posts2");

echo mysql_num_rows($qy_NwP);

$count = 0;

$trans = array("www.nbg-master.de/wiso/" => "www.wiwistud.de/", "hi" => "hello");
