<?php  
  ...
  if ($module == "")  {
      ...
      $query_user_pw = mysql_query("SELECT UserPass, UserID from $user_tblname WHERE UserID = '$userdata_id'");
      ...
      if ($usercp_data == "ok")  {
          ...
          $query_members_free_data = mysql_query("SELECT UserMail, UserID from $user_tblname");
