...
<table cellpadding="4" cellspacing="1" border="0" width="100%" class="tableinborder">
  ...
  <tr>
        ...
        Zur Ermittlung einer Rangliste der einzelnen <b>Bachelor-Lehrveranstaltungen</b> wurde eine Umfrage am Ende des <b>Wintersemesters 08/09</b>
...
$qy_awa_ss08   = mysql_query("SELECT * from awardws0809 WHERE semester = '1' && schwerpunkt = 'ap' ORDER BY ((gesamtnote)/(counter1))");
$tot_s1 = mysql_num_rows($qy_awa_ss08);

while ($rw_ss08 = mysql_fetch_assoc($qy_awa_ss08))  {

include("includes/awaWS0809_main.php");
 ...
 ?>
         ...
         Diese Veranstaltungen sind f&uuml;r das Sommersemester vorgesehen. Daher gab es im Sommersemester zumeist keine Vorlesungen oder &Uuml;bungen sondern lediglich
...
$qy_awa_ss08   = mysql_query("SELECT * from awardws0809 WHERE semester = '2' && schwerpunkt = 'ap' ORDER BY ((gesamtnote)/(counter1))");
$tot_s1 = mysql_num_rows($qy_awa_ss08);
...
$qy_awa_ss08   = mysql_query("SELECT * from awardws0809 WHERE semester = '3' && schwerpunkt = 'bp' && id != '22' ORDER BY ((gesamtnote)/(counter1))");
$tot_s1 = mysql_num_rows($qy_awa_ss08);
...
$qy_awa_ss08   = mysql_query("SELECT * from awardws0809 WHERE semester = '4' && schwerpunkt = 'bp' ORDER BY ((gesamtnote)/(counter1))");
$tot_s1 = mysql_num_rows($qy_awa_ss08);
...
$qy_awa_ss08   = mysql_query("SELECT * from awardws0809 WHERE schwerpunkt = 'bwl' ORDER BY ((gesamtnote)/(counter1))");
$tot_s1 = mysql_num_rows($qy_awa_ss08);
...
$qy_awa_ss08   = mysql_query("SELECT * from awardws0809 WHERE schwerpunkt = 'vwl' ORDER BY ((gesamtnote)/(counter1))");
$tot_s1 = mysql_num_rows($qy_awa_ss08);
...
$qy_awa_ss08   = mysql_query("SELECT * from awardws0809 WHERE schwerpunkt = 'info' ORDER BY ((gesamtnote)/(counter1))");
$tot_s1 = mysql_num_rows($qy_awa_ss08);
...
$qy_awa_ss08   = mysql_query("SELECT * from awardws0809 WHERE schwerpunkt = 'paed' ORDER BY ((gesamtnote)/(counter1))");
$tot_s1 = mysql_num_rows($qy_awa_ss08);
...
$qy_awa_ss08   = mysql_query("SELECT * from awardws0809 WHERE schwerpunkt = 'sonst' or id = '22' or id = '52' ORDER BY ((gesamtnote)/(counter1))");
$tot_s1 = mysql_num_rows($qy_awa_ss08);
