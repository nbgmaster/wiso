<?php
  ...
  */
  ...
  $query_p2 = mysql_query("SELECT user_id from unterlagen");  

  

  while  ($row_p2  =  mysql_fetch_assoc($query_p2))  {





    if (in_array($row_p2[user_id],$Ay_userids)) {



      echo"$row_p2[user_id]<br>";
  ...
  */
  ...
  $query_p = mysql_query("SELECT user_id from poll_votes");  
