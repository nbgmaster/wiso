...
#navi { cursor:pointer;         float:left;top: 0px;left:0px; right: 0px;  margin      : 0;
  padding     : 0;  width       : 800px;   font-size   : 12px;  height:26px;    }


#navi li { cursor:pointer; padding: 2px 0 0px 0; border-right : 1px solid #000; float: left; height: 25px;font-weight: bold;}


#navi li a {cursor:pointer;padding: 2px 0.54em 8px 0.53em; }
...
#navi li.active a {cursor:pointer; color: #D87502; text-decoration: none; }
