...
<td width="65%" align="left">
        ...
        <tr><td width="225">&nbsp;</td><td><table cellpadding="0" cellspacing="0" border="0">
                ...
                <tr><td class="tablea"><table><tr><td width="220"><b><span style="font-size:12px">Verh&auml;ltnis Arbeitaufwand/ECTS:</span></td><td class="tgfx">
                 <table cellspacing="0" cellpadding="0"><tr><td style="padding-left:30px">
...
$qy_awa_com1   = mysql_query("SELECT comment from award_comments_ws0809 WHERE course = '$rw_ss08[id]'");
