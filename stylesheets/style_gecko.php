...
body {
 ...
 // background  : url(./images/templates/<?php echo"$template"; ?>/main_bg.gif);
...
#head { 
  ...
  font-size   : 12px;
  font-weight : bold; 
  background  : #fff url(./images/templates/<?php echo"$template"; ?>/hoverbg.gif) repeat;
...
<?php if ($browser == "Safari" or $browser == "Opera")  { ?>
...
<?php if ($browser == "Netscape")  { ?>
  ...
  padding:4px 0.54em 0px 0.54em;        

<?php } else if ($browser == "Opera") { ?>

  padding:4px 0.52em 0px 0.54em;

<?php } else if ($browser == "FirefoxMac") { ?>

  padding:4px 0.49em 0px 0.44em;

<?php } else if ($browser == "Safari") { ?>

  padding:4px 0.45em 0px 0.45em;

<?php } else  { ?>

  padding:4px 0.71em 0px 0.34em;
...
#head li:hover {        
  ...
  color      : #fff;    
  background : #fff url(./images/templates/<?php echo"$template"; ?>/catpic_head.gif) 0 0 repeat;
...
.divIcon2 {text-align: center;text-valign: middle; float: left;width: 20px; height:18px;padding:-1px 0 0 0px; }
...
.gfxBarCredits div {
        ...
        height: 4px;
        font-size: 5px; /* needed for correct usage-bar display in IE-browsers */
}
